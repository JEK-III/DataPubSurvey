...
In a 1995 survey of 198 papers that used published datasets, 19\% cited the dataset with at least the title in the reference list\cite{sieber_not_1995}.
...
Despite the dismal state of practice, researchers agree that the correct approach is formal citation; 95\% of respondents to DataONE said that formal citation was a fair condition for data sharing, 87\% of astrobiologists said the same, and 71\% of biodiversisty researchers said they would like their data to be cited in the references ``like a normal publication''\cite{tenopir_data_2011, aydingolu_data_2014, enke_user's_2012}.
In this survey, the most popular response both to how a dataset creator should be credited and to how the respondent actually credited data creators was formal citation.
Furthermore, no respondents admitted to citing data informally in the text of a paper.
It may be that our respondents are particularly conscientious, that the effort of formal citation is easier to bring to mind, or that researchers define dataset reuse differently than the authors of the literature surveys.
...
Trackable formal data citations would be useful to the 71\% of respondents to the EAGDA survey who already trackeuse of their datasets ``through details of publications generated using the data''\cite{bobrow_establishing_2014}. 
