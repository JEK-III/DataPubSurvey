...
Data papers are colonizing existing journals like \emph{F1000Research} and \emph{Internet Archaeology} and founding dedicated journals such as \emph{Earth System Science Data}, \emph{Geoscience Data Journal}\cite{allan_geoscience_2014}, and Nature Publishing Group's \emph{Scientific Data}--- which 
concisely describes itself as ``a publication venue that credits scientists who share and explain their data." \cite{_more_2014}
...
Data papers, however, are by no means the only approach to data publication.
Data publishers include self-deposit repositories such as figshare(http://figshare.com/), Dryad(http://www.datadryad.org/), and Zenodo(http://zenodo.org/) with light metadata requirements and minimal validation.
