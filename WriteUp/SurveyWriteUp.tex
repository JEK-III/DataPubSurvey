...
Our analysis was restricted to the 249 (81\%) respondents who we deemed to be active researchers\ref{tab:demographics}.
...
We asked a number of questions to assess engagement and familiarity with data sharing and publication\ref{fig:policy_knowledge}.
...
Because the channel of sharing is a crucial feature of data publication\cite{kratz_data_2014} we asked researchers with data sharing experience about the medium of transmission \ref{fig:sharing}.
...
Crediting data creators is a primary concern in data publication, so we asked how a dataset creator should be credited by a reuser\ref{fig:credit}.
...
We decomposed the prevalent models of data publication into a set of potential features and asked respondents what would distinguish a ``published'' dataset from a ``shared'' one\ref{fig:definitions}.
