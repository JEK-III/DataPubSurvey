...
For breakdown of data by discipline or role, see the full raw-- except for redactions to preserve anonymity-- dataset published in the Unifersity of California's Merritt repository\cite{kratz_researcher_2014}.
...
% next two paragraphs need revision for style
...
Odds Ratios (ORs)\cite{szumilas_explaining_2010} and Fisher's exact test p-values were used to assess the relationships between items depicted in Figure \ref{fig:definition_web}; to enable meaningful comparison, all ORs were calculated in the direction that yeilded a value \geq 1.
