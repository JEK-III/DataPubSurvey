...
Publishing data with quality assurance facilitates reuse, but only if potential reusers trust the means of assurance.
Consequently, we asked respondents to rate how much confidence each of four possible assurances of data quality inspires.
All four  inspired at least some confidence in a large majority of researchers (from 89\% to 98\%).
