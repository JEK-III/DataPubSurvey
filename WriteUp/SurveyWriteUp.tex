...
The reproducibility problem that is currently embarrassing science in the scholarly\cite{ioannidis_why_2005, prinz_believe_2011, mobley_survey_2013} and mainstream\cite{zimmer_rise_2013, _how_2013, _trouble_2013} press could be addressed, in part, by opening data to scrutiny\cite{drew_lost_2013, collins_policy_2014}.
...
For instance, The National Snow and Ice Data Center (NSIDC) evaluates incoming data in a complex bureaucracy process that incorporates both internal technical expertise and external domain knowledge\cite{weaver_data_2012}.
...
Three strong correlations formed a triangle from appropriate methods to standardized metadata ($OR=7.91, p=0.00081$) to technical evaluation ($OR=4.56, p=3.4\times10^{-6}$) to appropriate methods ($OR=5.9, p=7.9\times10^{-5}$).
