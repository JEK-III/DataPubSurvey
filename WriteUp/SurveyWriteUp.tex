...
This endorsement has not weakened over the decades; more than 65\% of faculty at California Polytechnic State University (Cal Poly) affirmed the importance of data sharing in 2010, as did \cite{scaramozzino_study_2012} 94\% of the researchers in the United Kingdom (UK) that the Expert Advisor Group on Data Access (EAGDA) surveyed in 2013 \cite{bobrow_establishing_2014}.
The respondents to the 1985 survey endored data sharing ``to allow replication and extension of one's own findings'' \cite{ceci_scientists_1988}, and data sharing advocates seek to create these twin affordances: replication and (re)use.
...
Alsheikh-Ali et al. examined 351 articles and found that 59\% did not satisfy the data availability requirements of the journal in which they were published \cite{alsheikh-ali_public_2011}.
...
It is likely, however, that the predominance of direct contact is partly an artifact of persective, in that respondents know when they give someone their data directly, but they may not know when someone downloads it from a repository or website.
...
The respondents here (84\% North American) resemble those of the DataONE survey \cite{tenopir_data_2011} (73\% North American), and many of the previous surveys were conducted entiredly in the US \cite{ceci_scientists_1988, kim_institutional_2012, scaramozzino_study_2012}.
The in-depth reports prepared by EAGDA \cite{bobrow_establishing_2014} and the RIN \cite{swan_share_2008} were carried out in the UK.
There, a single assessment framework, the Research Excellence Framework (REF), is critical to most researchers, creating a significantly different environment in terms of credit.
...
As is the case for many of the previous surveys, participation was voluntary and uncontrolled, and responses are potentially biased toward researchers with an interest in data sharing and publication.
...
Only 16\% had been able to name a data journal at the start of the survey, so data papers may come to be valued more as awareness spreads; one respondent wrote ``I've never heard of this, but it sounds fantastic.''
Alternately, research communities may conclude that data papers should be valued less.
