...
We also tested differences in expectations between disciplines and research roles. The only two significant differences that we found both concern  metadata. Discipline had a significant effect on whether the respondent expected publication to include formal metadata (corrected $\alpha= 0.006$, $\chi^{2}= 33.0$, $p= 2.6\times10^{-5}$) and peer review to consider whether the metadata is formalized (corrected $\alpha= 0.008$, $\chi^{2}= 26.7$, $p= 3.8\times10^{-4}$).
