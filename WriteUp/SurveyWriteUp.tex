...
``Data publication'' conveys no single clear meaning to researchers.
Little has changed since the RIN concluded that ```publishing' datasets means different things to different researchers''\cite{swan_share_2008}.
Even its most frequently named feature, open availability, was only chosen by ~2/3 of respondents.
...
The first centers on preservation and access.
The two most popular features-- open availability and deposition in a repository-- were tightly correlated.
...
The second is a traditional conception that data that has been ``published'' is data that has been used in a traditional journal article. 
``Basis of a research paper'' was chosen by a sizable proportion (43\%) of respondents.
Interestingly, rather than competing, these two conceptions were completely independent.
