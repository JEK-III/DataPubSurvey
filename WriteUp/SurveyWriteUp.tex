...
In 1985, 59\% of scientists surveyed by DataONE complained that their colleagues were disinclined to share data\cite{cedi_scientists_1988}
...
In the UK, lack of time was cited by as a major constraint in the RIN report\cite{swan_share_2008} and more respondents to to EAGDA's survey felt constrained (66\% to some or great extent) by time\cite{bobrow_establishing_2014}.
...
Lack of time was cited as a reason for not sharing data in the DataONE survey by 54\% of respondents, more again than any other factor\cite{tenopir_data_2011}.
...
Data publication seeks to borrow terminology (``publication'', ``peer review'') from the existing publication system and in that way tie in to the existing academic reward system\cite{costello_motivating_2009, lawrence_data_2011, atici_other_2012}.
...
Data papers are descriptions of datasets including rationale and collections methods, without any analysis or conclusions\cite{newman_data_2009, callaghan_processes_2013}.
