...
The reproducibility problem plaguing science in the scholarly\cite{ioannidis_why_2005, prinz_believe_2011, mobley_survey_2013} and mainstream\cite{zimmer_rise_2012, _how_2013, _trouble_2013} press could be addressed, in part, by opening data to scrutiny\cite{drew_lost_2013, collins_nih_2014}.
...
It was the most frequent reason for not sharing data in the multidisciplinary DataONE survey (by 54\% of respondents)\cite{tenopir_data_2011} and the second most frequent (after the perception that no one needs the data) in a follow-up survey of Astrobiologists\cite{aydinoglu_data_2014}.
Time investment was the second most frequently raised objection to data sharing (after loss of control) in a 2012 survey of biodiversity researchers and the ``most violently discussed obstacle'' in associated interviews\cite{enke_users_2012}.
...
Our analysis was restricted to the 249 (81\%) respondents who we deemed to be active researchers\ref{demographics}.
...
We asked a number of questions to assess engagement and familiarity with data sharing and publication\ref{policy_knowledge}.
...
Because the channel of sharing is a crucial feature of data publication\cite{kratz_data_2014} we asked researchers with data sharing experience about the medium of transmission \ref{sharing}.
...
Crediting data creators is a primary concern in data publication, so we asked how a dataset creator should be credited by a reuser\ref{credit}.
...
We decomposed the prevalent models of data publication into a set of potential features and asked respondents what would distinguish a ``published'' dataset from a ``shared'' one\ref{definitions}.
...
%figure out how to boil this down to a single number
...
To identify relationships between specific items, we performed pairwise Fisher exact tests between each feature\ref{definition_web}.
...
To learn what indicators of quality researchers trust, we presented respondents with four possible indicators and asked how much to rate how much confidence each would confer\ref{values}.
...
Not surprisingly, respondents regarded data papers as much less valuable than traditional research papers; only 10\% valued a data paper a great deal. %60\% of respondents would give a traditional paper a great deal of weight
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=4in]{policy_knowledge.tif}
\end{center}
\caption{
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=4in]{sharing.tif}
\end{center}
\caption{
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=4in]{credit.tif}
\end{center}
\caption{
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=8in]{definitions.tif}
\end{center}
\caption{
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=4in]{definition_web.tif}
\end{center}
\caption{
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=8in]{values.tif}
\end{center}
\caption{
