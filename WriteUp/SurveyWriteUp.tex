...
The wides variety of forms of ``data publication'' attests to the fact that the term is still in the process of being defined.
Noting a lack of both consensus and interest on the part of researchers, the RIN report of 2009 adopted a deliberately minimal definition, ``making datasets publicly available''\cite{swan_share_2008}.
...
More restrictive definitions, such as a nuanced distinction between shared (available), \underline{p}ublished (also citable), and \underline{P}ublished (also peer-reviewed) data, are perhaps more useful \cite{callaghan_making_2012}.
